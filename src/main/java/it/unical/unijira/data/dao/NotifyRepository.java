...
public interface NotifyRepository extends JpaRepository<Notify, Long>, JpaSpecificationExecutor<Notify> {
    List<Notify> findByUserIdOrderByReadAscPriorityAscCreatedAtDesc(Long id);
    List<Notify> findByUserIdOrderByReadAscPriorityAscCreatedAtDesc(Long id, Pageable pageable);
}
